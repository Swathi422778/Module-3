...
### ALGORITHM
Initialize an empty tuple tuple1.

Read integer a from user input.

Loop from 9 up to (but not including) a in steps of 9:

In each iteration, append the current number i to tuple1.

Print the final tuple1.
